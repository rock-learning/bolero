...
sys.path.extend([
    ...
    os.path.abspath(root_path + '/doc/source'),
    os.path.abspath(root_path + '/doc/source/modules/generated'),
    os.path.abspath(root_path + '/doc/source/sphinxext'),
])
...
master_doc = 'index'
project = u'bolero'
copyright = u'2014, DFKI RIC, University of Bremen'
