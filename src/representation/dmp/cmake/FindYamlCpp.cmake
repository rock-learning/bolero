...
#ask pkg-config if it knows the location of yaml-cpp
include(FindPkgConfig)
pkg_check_modules(YAMLCPP_PKGCONFIG "yaml-cpp")
...
find_path(YAMLCPP_INCLUDE_DIR yaml-cpp/yaml.h
          ...
          /opt/yaml-cpp/
          ${YAMLCPP_DIR}/include/
          ${YAMLCPP_PKGCONFIG_INCLUDE_DIRS})
...
find_library(YAMLCPP_LIBRARY
             ...
             PATHS ~/Library/Frameworks
                    ...
                    /opt
                    ${YAMLCPP_DIR}/lib
                    ${YAMLCPP_PKGCONFIG_LIBRARY_DIRS})
